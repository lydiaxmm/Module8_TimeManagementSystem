$(document).ready(function() {
    var socket = io.connect("http://ec2-107-22-9-201.compute-1.amazonaws.com");
    var myRoomID = null;
    $("#chat").hide();
    $("#errors").hide();
    $("#name").focus();
...
//socket-y stuff
    ...
    socket.on("roomList", function(data) {
      $("#rooms").text("");
      $("#rooms").append("<li class=\"list-group-item active\">List of Project Groups <span class=\"badge\">"+data.count+"</span></li>");
       if (!jQuery.isEmptyObject(data.rooms)) { 
        ...
        $("#rooms").append("<li class=\"list-group-item\">There are no groups yet.</li>");
      }
    });
