...
$(document).ready(function() {
    ...
    document.getElementById("mybutton").onclick = function () {
        location.href = "http://ec2-107-22-9-201.compute-1.amazonaws.com:3456/index.html";
    };

    display_dates(dateArray[0],dateArray[6]);
    checkEmailSend();
    fetchProjects();
...
// Display dates
function display_dates(sun, sat) {
    var string = sun + "  -  " + sat;
    document.getElementById("display_dates").innerHTML = string;
}
...
function fetchProjectsCallback(event) {
	...
	for(var i in projects) {
	    var title = projects[i].title;
            ...
            button.innerHTML = "Join Projects";
...
function fetchTimesheetsCallback(event) {
	...
	for(var i in jsonData.timesheets) {
        ...
        cell.setAttribute("class", "cell_width");
